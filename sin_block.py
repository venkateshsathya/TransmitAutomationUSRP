...
class sin_block(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sin Block")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sin Block")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sin_block")
        ...
        # Blocks
        ##################################################
        self._RXGainSlider_range = Range(-30, 20, 1, 18, 200)
        self._RXGainSlider_win = RangeWidget(self._RXGainSlider_range, self.set_RXGainSlider, "RXGainSlider", "counter_slider", float)
        self.top_grid_layout.addWidget(self._RXGainSlider_win)
...
def main(top_block_cls=sin_block, options=None):
