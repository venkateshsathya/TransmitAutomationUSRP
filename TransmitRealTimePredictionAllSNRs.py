...
#	else:
	filelocation = '/home/venkatesh/Documents/USRPProject/DataCollect/IQSamples/Transmit/13SepDataForPaper/'
	modtype = sys.argv[1]
	SNR = sys.argv[2]
	if int(SNR)<0:
		SNR = 'minus' + SNR[1:]
		print(SNR)
	filenameReal =  glob.glob(filelocation + 'SNR' + SNR + '_' + modtype + 'Real.bin')
	filenameImag =  glob.glob(filelocation + 'SNR' + SNR + '_' + modtype +  'Imag.bin')
	print(filelocation)
	print(filenameReal)
