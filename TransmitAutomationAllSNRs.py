...
pythonUSRPcontrolFileLocation = '/home/venkatesh/Desktop/USRPProject/FlowGraphs/' 
pythonUSRPcontrolFileName = pythonUSRPcontrolFileLocation + 'TransmitUsrpControlAllSNRs.py'
DataTransmitDuration = 100
#DataTransmitDuration = 10
SleepDuration = 10

print('Deleting FileNameWritten.txt in /tmp folder of receive laptop before test start.')
os.system('/home/venkatesh/Desktop/USRPProject/FlowGraphs/deleteFileBeforeTest.sh')
initialSleep = 20 # We are giving sufficient time for us to start the reception automation after we start this transmission automation.
